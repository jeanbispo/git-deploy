...
define("REMOTE_REPOSITORY", "git@gitlab.com:astronomia-club/api.git"); // The SSH URL to your repository
define("DIR", "/var/www/html/astronomia/api/");                          // The path to your repostiroy; this must begin with a forward slash (/)
...
define("AFTER_PULL", "/usr/bin/yarn install && /usr/bin/env HOME=/home/www-data /usr/local/bin/pm2 restart astronomia_api --update-env");                                              // A command to execute after successfully pulling
